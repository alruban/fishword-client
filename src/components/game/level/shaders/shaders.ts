...
export default class Shaders extends Component {
  public name: string = 'Shaders';

  public global: string = /*glsl*/ `
    const float FOG_DISTANCE = 500.0;
  `;

  public skybox: string = /*glsl*/ `
    #include <common>
    ...
    const float STARS_VISIBILITY = 250.0;
  ...
  initialise() {
    ShaderChunk['global'] = this.global;
    ShaderChunk['skybox'] = this.skybox;
    ShaderChunk['ocean'] = this.ocean;
    ShaderChunk['parallax'] = this.parallax;
  }
}
